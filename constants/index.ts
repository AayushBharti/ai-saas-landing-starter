export const images = {
  ...
  cpuChip: "./assets/cpu-chip.svg",
  fingerPrint: "./assets/finger-print.svg",
  userGroup: "./assets/user-group.svg",
  ...
  vibeCodingImage: "/assets/benefits/yellow-v.jpg",
...
export const heroIcons = [sparkles, cpuChip, fingerPrint, userGroup]
...
export const benefits = [
  {
    id: "0",
    title: "Vibe coder launchpad",
    text: "Take control of your future. Build beautiful websites and powerful apps with the latest AI tools and frameworks.",
  ...
  },
  {
    ...
    text: "Build real-world business solutions. Master advanced AI tools to boost efficiency and solve common industry problems. Your next career leap starts here.",
    backgroundUrl: "assets/benefits/card-2.svg",
  ...
  },
  {
    ...
    text: "Prove your skills, commitment, and vision. This is your chance to earn a place as a partner in the Vibe Riders business and shape our future.",
  ...
  },
  {
    id: "3",
    title: "Future's Edge",
    text: "Join a global, decentralized youth movement. Experiment with emerging tech like AI and blockchain to build a fairer, more transparent future.",
  ...
  },
  {
    id: "4",
    title: "Life 3.0",
    text: "How can technology transform society? Explore and build solutions for better health, smarter education, and more connected communities.",
  ...
  },
  {
    id: "5",
    title: "City 3.0",
    text: "Reimagine the urban landscape. Join a collective of innovators using technology to create more livable, sustainable, and human-centered cities.",
